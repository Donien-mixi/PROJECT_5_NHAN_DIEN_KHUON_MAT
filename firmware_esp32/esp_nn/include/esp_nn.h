...
// ---- VENDORED PATCH (project: ESP32-S3 face attendance) ----
// Arduino IDE không có Kconfig, nên tự ép bật nhánh tối ưu + nạp sdkconfig
// để esp_nn.h nhận diện đúng target ESP32-S3 (CONFIG_IDF_TARGET_ESP32S3).
#include "sdkconfig.h"
#ifndef CONFIG_NN_OPTIMIZED
