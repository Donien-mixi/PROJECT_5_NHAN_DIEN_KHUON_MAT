...
def build_tinyface_ghost(input_shape=(64, 64, 1), embedding_dim=128, name="TinyFaceNet_Ghost_Fast"):
    ...
    # 4. Linear Embedding Bottleneck (128 dimensions) với Dropout chống học vẹt
    x_drop = layers.Dropout(0.2, name="head_dropout")(x)
    embeddings = layers.Dense(embedding_dim, use_bias=False, name="embedding_dense")(x_drop)
